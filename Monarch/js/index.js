...
//				},
			...
			"columns": [
                {"data": "name","width":"30%"},
                {"data": "hr.position","width":"3%"},
                {"data": "contact.0","width":"3%"},
                {"data": "contact.1"},
                {"data": "hr.start_date"},
                {"data": "hr.salary"},
                {"data": "hr.salary"},
...
//多选
 var table = $('#printshipping').DataTable();
 
     $("#printshipping").on("click","tr",function(){
